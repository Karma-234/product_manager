...
class Product_manager extends SqfEntityModelProvider {
  Product_manager() {
...
class Product_managerSequenceManager extends SqfEntityProvider {
  Product_managerSequenceManager() : super(Product_manager());
}
// END OF ENTITIES
